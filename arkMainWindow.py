...
class Ui_arkMainWindow(object):
    def setupUi(self, arkMainWindow):
        ...
        arkMainWindow.resize(480, 157)
        self.centralwidget = QtWidgets.QWidget(arkMainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.formLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 0, 461, 131))
    ...
    def retranslateUi(self, arkMainWindow):
        ...
        self.BIN_START.setStatusTip(_translate("arkMainWindow", "清空理智结束后，自动领取每日、访问线索。（注意：确认已开启代理）"))
