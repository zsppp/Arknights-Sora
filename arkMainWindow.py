...
class Ui_arkMainWindow(object):
    def setupUi(self, arkMainWindow):
        ...
        self.CB_CLUE = QtWidgets.QCheckBox(self.formLayoutWidget)
        self.CB_CLUE.setChecked(True)
        self.CB_CLUE.setObjectName("CB_CLUE")
        self.verticalLayout.addWidget(self.CB_CLUE)
    ...
    def retranslateUi(self, arkMainWindow):
        ...
        self.CB_CLUE.setStatusTip(_translate("arkMainWindow", "清空理智结束后，自动领取每日、访问线索。"))
        self.CB_CLUE.setText(_translate("arkMainWindow", "收取线索"))
